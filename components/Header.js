...
export default function Example() {
  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-3">
      ...
      >
        <p onClick={() => router.push('/')} className={`flex items-center cursor-pointer text-sm space-x-2 rounded-2xl p-2 hover:bg-opacity-25 hover:bg-white ${pathname === '/' && "bg-white bg-opacity-25"}`} >
